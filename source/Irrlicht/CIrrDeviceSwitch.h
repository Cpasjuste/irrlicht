...
namespace irr
{
	...
	class CIrrDeviceSwitch : public CIrrDeviceStub, video::IImagePresenter
	{
	public:

		//! constructor
		CIrrDeviceSwitch(const SIrrlichtCreationParameters& param);

		//! destructor
		virtual ~CIrrDeviceSwitch();
		...
		public:
			...
			CCursorControl(CIrrDeviceSwitch* dev)
